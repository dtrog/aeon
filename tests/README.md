...
```
europacashd --regtest --offline --fixed-difficulty 1
```
...
Open the wallet file with `europacash-wallet-rpc` with RPC port 11183. Finally, start tests by invoking ./blockchain.py or ./speed.py
